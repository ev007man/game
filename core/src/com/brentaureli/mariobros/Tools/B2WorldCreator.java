...
import com.brentaureli.mariobros.Sprites.Enemies.Boss;
...
import com.brentaureli.mariobros.Sprites.TileObjects.Checkpoint;
    ...
    public B2WorldCreator(PlayScreen screen){
        ...
        for(MapObject object : map.getLayers().get(5).getObjects().getByType(RectangleMapObject.class)){
            ...
            if (object.getProperties().containsKey("boss")) {
               boss = new Boss(screen, rect.getX() / MarioBros.PPM, rect.getY() / MarioBros.PPM);
            }
            else
